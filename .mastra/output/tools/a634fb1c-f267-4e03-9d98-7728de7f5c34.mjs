...
const listPullRequests = createTool({
  id: "listPullRequests",
...
const createPullRequest = createTool({
...
const updatePullRequest = createTool({
...
const mergePullRequest = createTool({
  id: "mergePullRequest",
...
const listPullRequestComments = createTool({
...
const createPullRequestComment = createTool({
...
const updatePullRequestComment = createTool({
...
const deletePullRequestComment = createTool({
...
const listPullRequestReviews = createTool({
...
const createPullRequestReview = createTool({
...
export { createPullRequest, createPullRequestComment, createPullRequestReview, deletePullRequestComment, getPullRequest, listPullRequestComments, listPullRequestReviews, listPullRequests, mergePullRequest, updatePullRequest, updatePullRequestComment };
