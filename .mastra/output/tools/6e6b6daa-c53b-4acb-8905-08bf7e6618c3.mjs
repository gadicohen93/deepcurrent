...
const listProjectCards = createTool({
  id: "listProjectCards",
...
const getProjectCard = createTool({
  id: "getProjectCard",
...
const createProjectCard = createTool({
  ...
  execute: async ({ context, tracingContext }) => {
    ...
    try {
      const params = { column_id: context.column_id };
...
const updateProjectCard = createTool({
...
const deleteProjectCard = createTool({
...
const moveProjectCard = createTool({
  id: "moveProjectCard",
...
const listProjectColumns = createTool({
...
const getProjectColumn = createTool({
  id: "getProjectColumn",
...
const createProjectColumn = createTool({
...
const updateProjectColumn = createTool({
...
const deleteProjectColumn = createTool({
...
const moveProjectColumn = createTool({
...
const listProjects = createTool({
  ...
  // This line was already present in the full file content, but not in the diff.
  execute: async ({ context, tracingContext }) => {
    const spanName = tracingContext?.currentSpan?.createChildSpan({
      type: AISpanType.GENERIC,
      name: "list_projects",
...
export { createProject, createProjectCard, createProjectColumn, deleteProject, deleteProjectCard, deleteProjectColumn, getProject, getProjectCard, getProjectColumn, listProjectCards, listProjectColumns, listProjects, moveProjectCard, moveProjectColumn, updateProject, updateProjectCard, updateProjectColumn };
