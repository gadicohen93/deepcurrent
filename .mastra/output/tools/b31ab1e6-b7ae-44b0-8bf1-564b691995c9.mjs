...
const searchIssuesAndPullRequests = createTool({
...
const searchRepositories = createTool({
...
export { searchCode, searchIssuesAndPullRequests, searchRepositories, searchUsers };
